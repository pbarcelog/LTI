...
- Write the commit message **in English** (per `ai-specs/ai-specs/specs/base-standards.mdc`).
...
- `ai-specs/ai-specs/specs/base-standards.mdc`: English-only for commit messages and technical artifacts.
- `ai-specs/ai-specs/specs/backend-standards.mdc` and `ai-specs/ai-specs/specs/frontend-standards.mdc`: Git Workflow (feature branches, descriptive commits, small focused branches).
